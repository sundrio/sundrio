...
public class VariableElementToArgument implements Function<VariableElement, Argument> {
  ...
  public VariableElementToArgument(AptContext context, Function<TypeMirror, TypeRef> referenceAdapterFunction,
  ...
  public Argument apply(final VariableElement variableElement) {
    String name = variableElement.getSimpleName().toString();

    TypeRef type = referenceAdapterFunction.apply(variableElement.asType());
    boolean isFinal = variableElement.getModifiers().contains(Modifier.FINAL);
    ...
    return new Argument(commentList, annotations, type, name, isFinal, new HashMap<>());
  }
