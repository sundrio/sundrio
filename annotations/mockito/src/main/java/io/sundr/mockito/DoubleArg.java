...
/**
 * An {@code Arg} variant for {@code double} parameters, using primitive-safe matchers.
 */
public final class DoubleArg {

  private ArgKind kind = ArgKind.ANY;
  private double value;
  private ArgumentMatcher<Double> matcher;
   ...
   */
  public void matching(ArgumentMatcher<Double> matcher) {
   ...
   */
  public void capturing(ArgumentCaptor<Double> captor) {
  ...
  public boolean matches(Object actual) {
    switch (kind) {
      ...
      case MATCHING:
        try {
          return matcher.matches((Double) actual);
