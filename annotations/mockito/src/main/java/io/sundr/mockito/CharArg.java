...
/**
 * An {@code Arg} variant for {@code char} parameters, using primitive-safe matchers.
 */
public final class CharArg {

  private ArgKind kind = ArgKind.ANY;
  private char value;
  private ArgumentMatcher<Character> matcher;
   ...
   */
  public void matching(ArgumentMatcher<Character> matcher) {
   ...
   */
  public void capturing(ArgumentCaptor<Character> captor) {
  ...
  public boolean matches(Object actual) {
    switch (kind) {
      ...
      case MATCHING:
        try {
          return matcher.matches((Character) actual);
