...
/**
 * An {@code Arg} variant for {@code byte} parameters, using primitive-safe matchers.
 */
public final class ByteArg {

  private ArgKind kind = ArgKind.ANY;
  private byte value;
  private ArgumentMatcher<Byte> matcher;
   ...
   */
  public void matching(ArgumentMatcher<Byte> matcher) {
   ...
   */
  public void capturing(ArgumentCaptor<Byte> captor) {
  ...
  public boolean matches(Object actual) {
    switch (kind) {
      ...
      case MATCHING:
        try {
          return matcher.matches((Byte) actual);
