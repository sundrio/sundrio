...
/**
 * An {@code Arg} variant for {@code int} parameters, using primitive-safe matchers.
 */
public final class IntArg {

  private ArgKind kind = ArgKind.ANY;
  private int value;
  private ArgumentMatcher<Integer> matcher;
   ...
   */
  public void matching(ArgumentMatcher<Integer> matcher) {
   ...
   */
  public void capturing(ArgumentCaptor<Integer> captor) {
