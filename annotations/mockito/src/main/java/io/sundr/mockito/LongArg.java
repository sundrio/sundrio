...
/**
 * An {@code Arg} variant for {@code long} parameters, using primitive-safe matchers.
 */
public final class LongArg {

  private ArgKind kind = ArgKind.ANY;
  private long value;
  private ArgumentMatcher<Long> matcher;
   ...
   */
  public void matching(ArgumentMatcher<Long> matcher) {
   ...
   */
  public void capturing(ArgumentCaptor<Long> captor) {
  ...
  public boolean matches(Object actual) {
    switch (kind) {
      ...
      case MATCHING:
        try {
          return matcher.matches((Long) actual);
