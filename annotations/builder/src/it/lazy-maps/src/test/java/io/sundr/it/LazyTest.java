...
public class LazyTest {
    ...
    public void shouldRespectWithNullMap() {
        Lazy item = new LazyBuilder().withMap(null).build();
        assertNull(item.getMap());
    }

    @Test
    public void shouldRespectWithMap() {
        Lazy item = new LazyBuilder().withMap(new HashMap<String,String>()).build();
    ...
    public void shouldRespecAddToMap() {
        Lazy item = new LazyBuilder().addToMap("foo", "bar").build();
        assertNotNull(item.getMap());
