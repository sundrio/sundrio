...
public class EagerTest {
    ...
    public void shouldRespectWithNull() {
        Eager item = new EagerBuilder().withList((List<Thing>)null).withSet((Set<Thing>)null).build();
    ...
    public void shouldRespecAddTo() {
        Eager item = new EagerBuilder().addToList(new Thing(1, "foo")).addToSet(new Thing(2, "bar")).build();
        assertNotNull(item.getList());
