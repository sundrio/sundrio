...
import io.sundr.model.ArgumentFluent;
...
public class ApplyTypeParamMappingToArgument implements Visitor<ArgumentFluent<?>> {

  private final Map<String, TypeRef> mappings;
  private final Optional<AttributeKey<TypeParamRef>> attributeKey;

  public ApplyTypeParamMappingToArgument(String name, TypeRef typeRef) {
    this(Maps.create(name, typeRef));
  }

  public ApplyTypeParamMappingToArgument(Map<String, TypeRef> mappings) {
  ...
  @Override
  public void visit(ArgumentFluent<?> property) {
