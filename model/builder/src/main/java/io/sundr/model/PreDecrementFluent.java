...
public class PreDecrementFluent<A extends io.sundr.model.PreDecrementFluent<A>> extends BaseFluent<A> {
  ...
  public PreDecrementFluent(PreDecrement instance) {
  ...
  protected void copyInstance(PreDecrement instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    PreDecrementFluent that = (PreDecrementFluent) o;
