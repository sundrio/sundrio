...
public class VariableFluent<T extends TypeRef, A extends io.sundr.model.VariableFluent<T, A>> extends ModifierSupportFluent<A> {
  ...
  public VariableFluent(Variable<T> instance) {
  ...
  protected void copyInstance(Variable<T> instance) {
    if (instance != null) {
      this.withModifiers(instance.getModifiers());
      this.withAttributes(instance.getAttributes());
      this.withComments(instance.getComments());
      this.withAnnotations(instance.getAnnotations());
      this.withTypeRef((T) instance.getTypeRef());
  ...
  public A withTypeRef(T typeRef) {
  ...
  public class AnnotationsNested<N> extends AnnotationRefFluent<AnnotationsNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) VariableFluent.this.setToAnnotations(index, builder.build());
    }
  ...
  public class ArgumentInitialValueNested<N> extends ArgumentFluent<ArgumentInitialValueNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) VariableFluent.this.withInitialValue(builder.build());
    }
