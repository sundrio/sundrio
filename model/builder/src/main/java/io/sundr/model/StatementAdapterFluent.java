...
public class StatementAdapterFluent<A extends StatementAdapterFluent<A>> extends BaseFluent<A> {
  public StatementAdapterFluent() {
  }

  public StatementAdapterFluent(StatementAdapter instance) {
    this.copyInstance(instance);
  }

  private VisitableBuilder<? extends Expression, ?> expression;

  protected void copyInstance(StatementAdapter instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    if (!super.equals(o))
      return false;
    StatementAdapterFluent that = (StatementAdapterFluent) o;
  ...
  public class MultiplyExpressionNested<N> extends MultiplyFluent<MultiplyExpressionNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) StatementAdapterFluent.this.withExpression(builder.build());
    }
