...
public class LocalVariableFluent<A extends io.sundr.model.LocalVariableFluent<A>> extends VariableFluent<TypeRef, A> {

  private boolean isFinal;
  private VisitableBuilder<? extends TypeRef, ?> typeRef;

  public LocalVariableFluent() {
  }

  public LocalVariableFluent(LocalVariable instance) {
  ...
  protected void copyInstance(LocalVariable instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    LocalVariableFluent that = (LocalVariableFluent) o;
  ...
  public class ClassRefTypeNested<N> extends ClassRefFluent<ClassRefTypeNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) LocalVariableFluent.this.withTypeRef(builder.build());
    }
