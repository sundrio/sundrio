...
public class InstanceOfFluent<A extends io.sundr.model.InstanceOfFluent<A>> extends BaseFluent<A> {
  ...
  public boolean equals(Object o) {
    ...
    InstanceOfFluent that = (InstanceOfFluent) o;
  ...
  public class TypeNested<N> extends ClassRefFluent<TypeNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) InstanceOfFluent.this.withType(builder.build());
    }
