...
public class CastFluent<A extends io.sundr.model.CastFluent<A>> extends BaseFluent<A> {
  ...
  public CastFluent(Cast instance) {
  ...
  protected void copyInstance(Cast instance) {
    if (instance != null) {
  ...
  public class ClassRefTypeNested<N> extends ClassRefFluent<ClassRefTypeNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) CastFluent.this.withType(builder.build());
    }
