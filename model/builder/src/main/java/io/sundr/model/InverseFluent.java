...
public class InverseFluent<A extends io.sundr.model.InverseFluent<A>> extends BaseFluent<A> {
  ...
  public boolean equals(Object o) {
    ...
    InverseFluent that = (InverseFluent) o;
  ...
  public class ArgumentExpresionNested<N> extends ArgumentFluent<ArgumentExpresionNested<N>> implements Nested<N> {
    ...
    public N and() {
      return (N) InverseFluent.this.withExpresion(builder.build());
    }
