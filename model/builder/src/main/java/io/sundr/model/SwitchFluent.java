...
public class SwitchFluent<A extends SwitchFluent<A>> extends BaseFluent<A> {
  ...
  public DefaultCaseNested<A> editDefaultCase() {
    return withNewDefaultCaseLike(
        java.util.Optional.ofNullable(buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(null));
  }

  public <T> DefaultCaseNested<?> editOrNewDefaultCase() {
    return withNewDefaultCaseLike(java.util.Optional.ofNullable(buildDefaultCase())
  ...
  public DefaultCaseNested<A> editOrNewDefaultCaseLike(Block item) {
    return withNewDefaultCaseLike(
        java.util.Optional.ofNullable(buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(item));
  }
