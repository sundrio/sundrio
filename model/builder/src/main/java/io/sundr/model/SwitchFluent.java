...
public class SwitchFluent<A extends SwitchFluent<A>> extends BaseFluent<A> {
  ...
  public DefaultCaseNested<A> editDefaultCase() {
    return withNewDefaultCaseLike(
        Optional.ofNullable(buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(null));
  }

  public <T> DefaultCaseNested<?> editOrNewDefaultCase() {
    return withNewDefaultCaseLike(Optional.ofNullable(buildDefaultCase()).flatMap(java.util.function.Function.identity())
        .orElse(new BlockBuilder().build()));
  }

  public DefaultCaseNested<A> editOrNewDefaultCaseLike(Block item) {
    return withNewDefaultCaseLike(
        Optional.ofNullable(buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(item));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!java.util.Objects.equals(expression, that.expression))
      return false;
    if (!java.util.Objects.equals(cases, that.cases))
      return false;
    if (!java.util.Objects.equals(defaultCase, that.defaultCase))
      return false;
    return true;
  }
  ...
  public int hashCode() {
    return java.util.Objects.hash(expression, cases, defaultCase, super.hashCode());
  }
