...
public class SwitchFluent<A extends io.sundr.model.SwitchFluent<A>> extends BaseFluent<A> {
  ...
  public A addToCases(Map<ValueRef, Block> map) {
    if (this.cases == null && map != null) {
  ...
  public A addToCases(ValueRef key, Block value) {
    if (this.cases == null && key != null && value != null) {
      this.cases = new LinkedHashMap();
    }
  ...
  public Optional<Block> buildDefaultCase() {
    return this.defaultCase != null ? this.defaultCase.map(v -> v.build()) : Optional.empty();
  }
  ...
  public DefaultCaseNested<A> editDefaultCase() {
    return this.withNewDefaultCaseLike(
        Optional.ofNullable(this.buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(null));
  }

  public <T> DefaultCaseNested<?> editOrNewDefaultCase() {
    return this.withNewDefaultCaseLike(Optional.ofNullable(this.buildDefaultCase())
        .flatMap(java.util.function.Function.identity()).orElse(new BlockBuilder().build()));
  }

  public DefaultCaseNested<A> editOrNewDefaultCaseLike(Block item) {
    return this.withNewDefaultCaseLike(
        Optional.ofNullable(this.buildDefaultCase()).flatMap(java.util.function.Function.identity()).orElse(item));
  }
  ...
  public boolean equals(Object o) {
    ...
    SwitchFluent that = (SwitchFluent) o;
    if (!(Objects.equals(expression, that.expression))) {
      return false;
    }
    if (!(Objects.equals(cases, that.cases))) {
      return false;
    }
    if (!(Objects.equals(defaultCase, that.defaultCase))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    return Objects.hash(expression, cases, defaultCase);
  }

  public A removeFromCases(ValueRef key) {
    if (this.cases == null) {
      return (A) this;
    }
    if (key != null && this.cases != null) {
      this.cases.remove(key);
    }
    return (A) this;
  }

  public A removeFromCases(Map<ValueRef, Block> map) {
    if (this.cases == null) {
      return (A) this;
    }
    if (map != null) {
  ...
  public <K, V> A withCases(Map<ValueRef, Block> cases) {
    if (cases == null) {
      this.cases = null;
    } else {
  ...
  public DefaultCaseNested<A> withNewDefaultCase() {
    return new DefaultCaseNested(null);
  }

  public DefaultCaseNested<A> withNewDefaultCaseLike(Block item) {
    return new DefaultCaseNested(item);
  }
  ...
  public class DefaultCaseNested<N> extends BlockFluent<DefaultCaseNested<N>> implements Nested<N> {

    BlockBuilder builder;

    DefaultCaseNested(Block item) {
      this.builder = new BlockBuilder(this, item);
    }

    public N and() {
      return (N) SwitchFluent.this.withDefaultCase(builder.build());
    }

    public N endDefaultCase() {
      return and();
    }
