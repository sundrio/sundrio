...
public class EditableMethod extends Method implements Editable<MethodBuilder> {
  ...
  public EditableMethod(List<String> comments, List<AnnotationRef> annotations, List<TypeParamDef> parameters, String name,
    ...
    super(comments, annotations, parameters, name, returnType, arguments, varArgPreferred, exceptions, defaultMethod, block,
