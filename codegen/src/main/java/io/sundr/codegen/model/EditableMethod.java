...
public class EditableMethod extends Method implements Editable<MethodBuilder> {
    ...
    public EditableMethod(Set<TypeRef> annotations, Set<TypeParamDef> parameters, String name, TypeRef returnType, Property[] arguments, Set<TypeRef> exceptions, Block block, int modifiers, Map<String, Object> attributes) {
