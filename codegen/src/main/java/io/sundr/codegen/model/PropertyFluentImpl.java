...
public class PropertyFluentImpl<A extends PropertyFluent<A>> extends ModifierSupportFluentImpl<A> implements PropertyFluent<A> {
    ...
    public A withVoidRefTypeRef(VoidRef voidRefTypeRef) {
        if (typeRef != null) {
            this.typeRef = new VoidRefBuilder(voidRefTypeRef);
            _visitables.add(this.typeRef);
        }
        return (A) this;
    }
    ...
    public A withWildcardRefTypeRef(WildcardRef wildcardRefTypeRef) {
        if (typeRef != null) {
            this.typeRef = new WildcardRefBuilder(wildcardRefTypeRef);
            _visitables.add(this.typeRef);
        }
        return (A) this;
    }
    ...
    public A withPrimitiveRefTypeRef(PrimitiveRef primitiveRefTypeRef) {
        if (typeRef != null) {
            this.typeRef = new PrimitiveRefBuilder(primitiveRefTypeRef);
            _visitables.add(this.typeRef);
        }
        return (A) this;
    }
    ...
    public A withTypeParamRefTypeRef(TypeParamRef typeParamRefTypeRef) {
        if (typeRef != null) {
            this.typeRef = new TypeParamRefBuilder(typeParamRefTypeRef);
            _visitables.add(this.typeRef);
        }
        return (A) this;
    }
    ...
    public A withClassRefTypeRef(ClassRef classRefTypeRef) {
        if (typeRef != null) {
            this.typeRef = new ClassRefBuilder(classRefTypeRef);
            _visitables.add(this.typeRef);
        }
        return (A) this;
    }
