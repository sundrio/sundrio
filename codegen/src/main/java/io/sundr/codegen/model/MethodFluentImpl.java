...
@Deprecated public List<TypeParamDef> getParameters() {
    ...
    public A withParameters(List<TypeParamDef> parameters) {
        ...
        if (parameters != null) {this.parameters = new ArrayList<TypeParamDefBuilder>(); for (TypeParamDef item : parameters){this.addToParameters(item);}} else { this.parameters = null;} return (A) this;
    }
...
@Deprecated public List<Property> getArguments() {
    ...
    public A withArguments(List<Property> arguments) {
        ...
        if (arguments != null) {this.arguments = new ArrayList<PropertyBuilder>(); for (Property item : arguments){this.addToArguments(item);}} else { this.arguments = null;} return (A) this;
    }
    ...
    public A removeMatchingFromExceptions(Predicate<ClassRefBuilder> predicate) {
        if (exceptions == null) return (A) this;
...
@Deprecated public List<ClassRef> getExceptions() {
    ...
    public A withExceptions(List<ClassRef> exceptions) {
        ...
        if (exceptions != null) {this.exceptions = new ArrayList<ClassRefBuilder>(); for (ClassRef item : exceptions){this.addToExceptions(item);}} else { this.exceptions = null;} return (A) this;
    }
    ...
    public A withDefaultMethod(boolean defaultMethod) {
        this.defaultMethod=defaultMethod; return (A) this;
    }
...
@Deprecated public Block getBlock() {
    ...
    public boolean equals(Object o) {
        ...
        if (defaultMethod != that.defaultMethod) return false;
        if (block != null ? !block.equals(that.block) :that.block != null) return false;
        return true;
    }

    public int hashCode() {
        return java.util.Objects.hash(comments,  annotations,  parameters,  name,  returnType,  arguments,  varArgPreferred,  exceptions,  defaultMethod,  block,  super.hashCode());
    }
