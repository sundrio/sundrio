...
public class JavaClazz extends AttributeSupport implements Clazz<JavaType, JavaProperty> {
    ...
    private final Set<io.sundr.codegen.model.JavaClazz> nested;

    @Buildable
    public JavaClazz(JavaType type, Set<JavaMethod> constructors, Set<JavaMethod> methods, Set<JavaProperty> fields, Set<JavaType> imports, Map<String, Object> attributes, Set<io.sundr.codegen.model.JavaClazz> nested) {
        super(attributes);
        this.type = type;
    ...
    public Set<io.sundr.codegen.model.JavaClazz> getNested() {
        return nested;
    }
