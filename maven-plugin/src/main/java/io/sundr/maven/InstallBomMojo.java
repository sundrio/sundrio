...
@Mojo(name = "install-bom", inheritByDefault = false, defaultPhase = LifecyclePhase.INSTALL)
public class InstallBomMojo extends AbstractSundrioMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        if (getProject().isExecutionRoot()) {
            ...
            try {
                ...
                throw new MojoFailureException("Failed to install bom.");
            }
        }
    }
}
